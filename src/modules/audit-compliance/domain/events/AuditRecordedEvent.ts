...
export interface AuditRecordedEventPayload {
...
/**
 * Domain Event: AuditRecordedEvent
 * Dispatched when  audit recorded event occurs in audit-compliance.
 */
export class AuditRecordedEvent extends DomainEvent {
  public readonly eventName = "AuditRecordedEvent";
  ...
  constructor(payload: AuditRecordedEventPayload | string) {
    super();
