...
import type { IDataDeletionRequestRepository, IDataDeletionRequestFilterOptions } from "../domain/IDataDeletionRequestRepository.ts";

/**
 * InMemory Repository for DataDeletionRequest
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryDataDeletionRequestRepository extends InMemoryRepository<DataDeletionRequest> implements IDataDeletionRequestRepository {
  public async findByName(name: string): Promise<DataDeletionRequest | null> {
  ...
  public async findByCode(code: string): Promise<DataDeletionRequest | null> {
  ...
  public async findFiltered(options: IDataDeletionRequestFilterOptions = {}): Promise<DataDeletionRequest[]> {
  ...
  public async count(options: IDataDeletionRequestFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: DataDeletionRequest[]): Promise<void> {
