...
import type { IIpAccessLogRepository, IIpAccessLogFilterOptions } from "../domain/IIpAccessLogRepository.ts";

/**
 * InMemory Repository for IpAccessLog
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryIpAccessLogRepository extends InMemoryRepository<IpAccessLog> implements IIpAccessLogRepository {
  public async findByName(name: string): Promise<IpAccessLog | null> {
  ...
  public async findByCode(code: string): Promise<IpAccessLog | null> {
  ...
  public async findFiltered(options: IIpAccessLogFilterOptions = {}): Promise<IpAccessLog[]> {
  ...
  public async count(options: IIpAccessLogFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: IpAccessLog[]): Promise<void> {
