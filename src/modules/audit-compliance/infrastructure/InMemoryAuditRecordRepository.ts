...
import type { IAuditRecordRepository, IAuditRecordFilterOptions } from "../domain/IAuditRecordRepository.ts";

/**
 * InMemory Repository for AuditRecord
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryAuditRecordRepository extends InMemoryRepository<AuditRecord> implements IAuditRecordRepository {
  public async findByName(name: string): Promise<AuditRecord | null> {
  ...
  public async findByCode(code: string): Promise<AuditRecord | null> {
  ...
  public async findFiltered(options: IAuditRecordFilterOptions = {}): Promise<AuditRecord[]> {
  ...
  public async count(options: IAuditRecordFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: AuditRecord[]): Promise<void> {
