...
import type { ISecurityAlertRepository, ISecurityAlertFilterOptions } from "../domain/ISecurityAlertRepository.ts";

/**
 * InMemory Repository for SecurityAlert
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySecurityAlertRepository extends InMemoryRepository<SecurityAlert> implements ISecurityAlertRepository {
  public async findByName(name: string): Promise<SecurityAlert | null> {
  ...
  public async findByCode(code: string): Promise<SecurityAlert | null> {
  ...
  public async findFiltered(options: ISecurityAlertFilterOptions = {}): Promise<SecurityAlert[]> {
  ...
  public async count(options: ISecurityAlertFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SecurityAlert[]): Promise<void> {
