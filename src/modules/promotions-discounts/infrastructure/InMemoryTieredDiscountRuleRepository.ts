...
import type { ITieredDiscountRuleRepository, ITieredDiscountRuleFilterOptions } from "../domain/ITieredDiscountRuleRepository.ts";

/**
 * InMemory Repository for TieredDiscountRule
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTieredDiscountRuleRepository extends InMemoryRepository<TieredDiscountRule> implements ITieredDiscountRuleRepository {
  public async findByName(name: string): Promise<TieredDiscountRule | null> {
  ...
  public async findByCode(code: string): Promise<TieredDiscountRule | null> {
  ...
  public async findFiltered(options: ITieredDiscountRuleFilterOptions = {}): Promise<TieredDiscountRule[]> {
  ...
  public async count(options: ITieredDiscountRuleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TieredDiscountRule[]): Promise<void> {
