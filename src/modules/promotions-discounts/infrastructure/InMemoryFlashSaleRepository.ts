...
import type { IFlashSaleRepository, IFlashSaleFilterOptions } from "../domain/IFlashSaleRepository.ts";

/**
 * InMemory Repository for FlashSale
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryFlashSaleRepository extends InMemoryRepository<FlashSale> implements IFlashSaleRepository {
  public async findByName(name: string): Promise<FlashSale | null> {
  ...
  public async findByCode(code: string): Promise<FlashSale | null> {
  ...
  public async findFiltered(options: IFlashSaleFilterOptions = {}): Promise<FlashSale[]> {
  ...
  public async count(options: IFlashSaleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: FlashSale[]): Promise<void> {
