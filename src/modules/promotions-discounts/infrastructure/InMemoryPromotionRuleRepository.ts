...
import type { IPromotionRuleRepository, IPromotionRuleFilterOptions } from "../domain/IPromotionRuleRepository.ts";

/**
 * InMemory Repository for PromotionRule
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPromotionRuleRepository extends InMemoryRepository<PromotionRule> implements IPromotionRuleRepository {
  public async findByName(name: string): Promise<PromotionRule | null> {
  ...
  public async findByCode(code: string): Promise<PromotionRule | null> {
  ...
  public async findFiltered(options: IPromotionRuleFilterOptions = {}): Promise<PromotionRule[]> {
  ...
  public async count(options: IPromotionRuleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PromotionRule[]): Promise<void> {
