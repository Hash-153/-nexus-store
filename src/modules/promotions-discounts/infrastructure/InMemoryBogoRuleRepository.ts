...
import type { IBogoRuleRepository, IBogoRuleFilterOptions } from "../domain/IBogoRuleRepository.ts";

/**
 * InMemory Repository for BogoRule
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBogoRuleRepository extends InMemoryRepository<BogoRule> implements IBogoRuleRepository {
  public async findByName(name: string): Promise<BogoRule | null> {
  ...
  public async findByCode(code: string): Promise<BogoRule | null> {
  ...
  public async findFiltered(options: IBogoRuleFilterOptions = {}): Promise<BogoRule[]> {
  ...
  public async count(options: IBogoRuleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BogoRule[]): Promise<void> {
