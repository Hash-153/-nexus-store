...
import type { IBundleDiscountRepository, IBundleDiscountFilterOptions } from "../domain/IBundleDiscountRepository.ts";

/**
 * InMemory Repository for BundleDiscount
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBundleDiscountRepository extends InMemoryRepository<BundleDiscount> implements IBundleDiscountRepository {
  public async findByName(name: string): Promise<BundleDiscount | null> {
  ...
  public async findByCode(code: string): Promise<BundleDiscount | null> {
  ...
  public async findFiltered(options: IBundleDiscountFilterOptions = {}): Promise<BundleDiscount[]> {
  ...
  public async count(options: IBundleDiscountFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BundleDiscount[]): Promise<void> {
