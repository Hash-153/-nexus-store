...
export interface PromotionAppliedEventPayload {
...
/**
 * Domain Event: PromotionAppliedEvent
 * Dispatched when  promotion applied event occurs in promotions-discounts.
 */
export class PromotionAppliedEvent extends DomainEvent {
  public readonly eventName = "PromotionAppliedEvent";
  ...
  constructor(payload: PromotionAppliedEventPayload | string) {
    super();
