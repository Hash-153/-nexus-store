...
export interface CouponCreatedEventPayload {
...
/**
 * Domain Event: CouponCreatedEvent
 * Dispatched when  coupon created event occurs in promotions-discounts.
 */
export class CouponCreatedEvent extends DomainEvent {
  public readonly eventName = "CouponCreatedEvent";
  ...
  constructor(payload: CouponCreatedEventPayload | string) {
    super();
