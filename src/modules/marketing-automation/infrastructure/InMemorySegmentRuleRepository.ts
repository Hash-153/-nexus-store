...
import type { ISegmentRuleRepository, ISegmentRuleFilterOptions } from "../domain/ISegmentRuleRepository.ts";

/**
 * InMemory Repository for SegmentRule
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySegmentRuleRepository extends InMemoryRepository<SegmentRule> implements ISegmentRuleRepository {
  public async findByName(name: string): Promise<SegmentRule | null> {
  ...
  public async findByCode(code: string): Promise<SegmentRule | null> {
  ...
  public async findFiltered(options: ISegmentRuleFilterOptions = {}): Promise<SegmentRule[]> {
  ...
  public async count(options: ISegmentRuleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SegmentRule[]): Promise<void> {
