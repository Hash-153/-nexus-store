...
import type { IAbandonedCartRecordRepository, IAbandonedCartRecordFilterOptions } from "../domain/IAbandonedCartRecordRepository.ts";

/**
 * InMemory Repository for AbandonedCartRecord
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryAbandonedCartRecordRepository extends InMemoryRepository<AbandonedCartRecord> implements IAbandonedCartRecordRepository {
  public async findByName(name: string): Promise<AbandonedCartRecord | null> {
  ...
  public async findByCode(code: string): Promise<AbandonedCartRecord | null> {
  ...
  public async findFiltered(options: IAbandonedCartRecordFilterOptions = {}): Promise<AbandonedCartRecord[]> {
  ...
  public async count(options: IAbandonedCartRecordFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: AbandonedCartRecord[]): Promise<void> {
