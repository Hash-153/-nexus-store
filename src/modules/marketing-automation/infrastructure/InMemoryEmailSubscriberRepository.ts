...
import type { IEmailSubscriberRepository, IEmailSubscriberFilterOptions } from "../domain/IEmailSubscriberRepository.ts";

/**
 * InMemory Repository for EmailSubscriber
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryEmailSubscriberRepository extends InMemoryRepository<EmailSubscriber> implements IEmailSubscriberRepository {
  public async findByName(name: string): Promise<EmailSubscriber | null> {
  ...
  public async findByCode(code: string): Promise<EmailSubscriber | null> {
  ...
  public async findFiltered(options: IEmailSubscriberFilterOptions = {}): Promise<EmailSubscriber[]> {
  ...
  public async count(options: IEmailSubscriberFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: EmailSubscriber[]): Promise<void> {
