...
import type { IPriceDropSubscriptionRepository, IPriceDropSubscriptionFilterOptions } from "../domain/IPriceDropSubscriptionRepository.ts";

/**
 * InMemory Repository for PriceDropSubscription
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPriceDropSubscriptionRepository extends InMemoryRepository<PriceDropSubscription> implements IPriceDropSubscriptionRepository {
  public async findByName(name: string): Promise<PriceDropSubscription | null> {
  ...
  public async findByCode(code: string): Promise<PriceDropSubscription | null> {
  ...
  public async findFiltered(options: IPriceDropSubscriptionFilterOptions = {}): Promise<PriceDropSubscription[]> {
  ...
  public async count(options: IPriceDropSubscriptionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PriceDropSubscription[]): Promise<void> {
