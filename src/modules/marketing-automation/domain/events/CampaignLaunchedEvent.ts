...
export interface CampaignLaunchedEventPayload {
...
/**
 * Domain Event: CampaignLaunchedEvent
 * Dispatched when  campaign launched event occurs in marketing-automation.
 */
export class CampaignLaunchedEvent extends DomainEvent {
  public readonly eventName = "CampaignLaunchedEvent";
  ...
  constructor(payload: CampaignLaunchedEventPayload | string) {
    super();
