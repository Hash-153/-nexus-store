...
/**
 * Domain Aggregate Root: Campaign
 * Encapsulates state and business invariants for Campaign within marketing-automation.
 */
export class Campaign extends AggregateRoot<CampaignProps> {
  private _versionNumber: number = 1;

  public constructor(props: CampaignProps, id?: string, createdAt?: Date, updatedAt?: Date) {
  ...
  public static create(props: CampaignProps, id?: string): Campaign {
    ...
    if (props.code !== undefined && props.code.trim().length === 0) {
      throw new ValidationError("Campaign code cannot be empty.");
    }
  ...
  public static reconstitute(props: CampaignProps, id: string, createdAt: Date, updatedAt: Date): Campaign {
    return new Campaign(props, id, createdAt, updatedAt);
  }

  public updateDetails(updates: Partial<CampaignProps>): void {
