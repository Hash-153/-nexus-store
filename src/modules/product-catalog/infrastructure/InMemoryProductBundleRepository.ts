...
import type { IProductBundleRepository, IProductBundleFilterOptions } from "../domain/IProductBundleRepository.ts";

/**
 * InMemory Repository for ProductBundle
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProductBundleRepository extends InMemoryRepository<ProductBundle> implements IProductBundleRepository {
  public async findByName(name: string): Promise<ProductBundle | null> {
  ...
  public async findByCode(code: string): Promise<ProductBundle | null> {
  ...
  public async findFiltered(options: IProductBundleFilterOptions = {}): Promise<ProductBundle[]> {
  ...
  public async count(options: IProductBundleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProductBundle[]): Promise<void> {
