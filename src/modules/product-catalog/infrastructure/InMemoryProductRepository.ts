...
import type { IProductRepository, IProductFilterOptions } from "../domain/IProductRepository.ts";

/**
 * InMemory Repository for Product
...
export class InMemoryProductRepository extends InMemoryRepository<Product> implements IProductRepository {
  ...
  public async findFiltered(options: IProductFilterOptions = {}): Promise<Product[]> {
  ...
  public async count(options: IProductFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: Product[]): Promise<void> {
