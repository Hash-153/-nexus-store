...
import type { ICollectionRepository, ICollectionFilterOptions } from "../domain/ICollectionRepository.ts";

/**
 * InMemory Repository for Collection
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCollectionRepository extends InMemoryRepository<Collection> implements ICollectionRepository {
  public async findByName(name: string): Promise<Collection | null> {
  ...
  public async findByCode(code: string): Promise<Collection | null> {
  ...
  public async findFiltered(options: ICollectionFilterOptions = {}): Promise<Collection[]> {
  ...
  public async count(options: ICollectionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: Collection[]): Promise<void> {
