...
import type { IProductTagRepository, IProductTagFilterOptions } from "../domain/IProductTagRepository.ts";

/**
 * InMemory Repository for ProductTag
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProductTagRepository extends InMemoryRepository<ProductTag> implements IProductTagRepository {
  public async findByName(name: string): Promise<ProductTag | null> {
  ...
  public async findByCode(code: string): Promise<ProductTag | null> {
  ...
  public async findFiltered(options: IProductTagFilterOptions = {}): Promise<ProductTag[]> {
  ...
  public async count(options: IProductTagFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProductTag[]): Promise<void> {
