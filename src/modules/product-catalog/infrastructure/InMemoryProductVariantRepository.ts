...
import type { IProductVariantRepository, IProductVariantFilterOptions } from "../domain/IProductVariantRepository.ts";

/**
 * InMemory Repository for ProductVariant
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProductVariantRepository extends InMemoryRepository<ProductVariant> implements IProductVariantRepository {
  public async findByName(name: string): Promise<ProductVariant | null> {
  ...
  public async findByCode(code: string): Promise<ProductVariant | null> {
  ...
  public async findFiltered(options: IProductVariantFilterOptions = {}): Promise<ProductVariant[]> {
  ...
  public async count(options: IProductVariantFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProductVariant[]): Promise<void> {
