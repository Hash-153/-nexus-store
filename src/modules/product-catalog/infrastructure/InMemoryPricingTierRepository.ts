...
import type { IPricingTierRepository, IPricingTierFilterOptions } from "../domain/IPricingTierRepository.ts";

/**
 * InMemory Repository for PricingTier
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPricingTierRepository extends InMemoryRepository<PricingTier> implements IPricingTierRepository {
  public async findByName(name: string): Promise<PricingTier | null> {
  ...
  public async findByCode(code: string): Promise<PricingTier | null> {
  ...
  public async findFiltered(options: IPricingTierFilterOptions = {}): Promise<PricingTier[]> {
  ...
  public async count(options: IPricingTierFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PricingTier[]): Promise<void> {
