...
import type { IProductAttributeRepository, IProductAttributeFilterOptions } from "../domain/IProductAttributeRepository.ts";

/**
 * InMemory Repository for ProductAttribute
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProductAttributeRepository extends InMemoryRepository<ProductAttribute> implements IProductAttributeRepository {
  public async findByName(name: string): Promise<ProductAttribute | null> {
  ...
  public async findByCode(code: string): Promise<ProductAttribute | null> {
  ...
  public async findFiltered(options: IProductAttributeFilterOptions = {}): Promise<ProductAttribute[]> {
  ...
  public async count(options: IProductAttributeFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProductAttribute[]): Promise<void> {
