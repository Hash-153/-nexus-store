...
import type { IProductMediaRepository, IProductMediaFilterOptions } from "../domain/IProductMediaRepository.ts";

/**
 * InMemory Repository for ProductMedia
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProductMediaRepository extends InMemoryRepository<ProductMedia> implements IProductMediaRepository {
  public async findByName(name: string): Promise<ProductMedia | null> {
  ...
  public async findByCode(code: string): Promise<ProductMedia | null> {
  ...
  public async findFiltered(options: IProductMediaFilterOptions = {}): Promise<ProductMedia[]> {
  ...
  public async count(options: IProductMediaFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProductMedia[]): Promise<void> {
