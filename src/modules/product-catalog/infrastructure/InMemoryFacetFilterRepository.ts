...
import type { IFacetFilterRepository, IFacetFilterFilterOptions } from "../domain/IFacetFilterRepository.ts";

/**
 * InMemory Repository for FacetFilter
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryFacetFilterRepository extends InMemoryRepository<FacetFilter> implements IFacetFilterRepository {
  public async findByName(name: string): Promise<FacetFilter | null> {
  ...
  public async findByCode(code: string): Promise<FacetFilter | null> {
  ...
  public async findFiltered(options: IFacetFilterFilterOptions = {}): Promise<FacetFilter[]> {
  ...
  public async count(options: IFacetFilterFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: FacetFilter[]): Promise<void> {
