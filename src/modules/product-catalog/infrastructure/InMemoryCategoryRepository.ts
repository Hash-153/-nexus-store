...
import type { ICategoryRepository, ICategoryFilterOptions } from "../domain/ICategoryRepository.ts";

/**
 * InMemory Repository for Category
...
export class InMemoryCategoryRepository extends InMemoryRepository<Category> implements ICategoryRepository {
  ...
  public async findFiltered(options: ICategoryFilterOptions = {}): Promise<Category[]> {
  ...
  public async count(options: ICategoryFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: Category[]): Promise<void> {
