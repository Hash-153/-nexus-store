...
export interface ProductArchivedEventPayload {
 ...
 * Dispatched when  product archived event occurs in product-catalog.
 */
export class ProductArchivedEvent extends DomainEvent {
  ...
  constructor(payload: ProductArchivedEventPayload | string) {
    super();
