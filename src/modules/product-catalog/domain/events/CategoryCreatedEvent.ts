...
/**
 * Domain Event: CategoryCreatedEvent
 * Dispatched when  category created event occurs in product-catalog.
 */
export class CategoryCreatedEvent extends DomainEvent {
  ...
  constructor(payload: CategoryCreatedEventPayload | string) {
    super();
