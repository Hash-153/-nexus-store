...
export interface BundleCreatedEventPayload {
...
/**
 * Domain Event: BundleCreatedEvent
 * Dispatched when  bundle created event occurs in product-catalog.
 */
export class BundleCreatedEvent extends DomainEvent {
  public readonly eventName = "BundleCreatedEvent";
  ...
  constructor(payload: BundleCreatedEventPayload | string) {
    super();
