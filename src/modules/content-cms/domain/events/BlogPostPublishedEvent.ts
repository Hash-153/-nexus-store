...
/**
 * Domain Event: BlogPostPublishedEvent
 * Dispatched when  blog post published event occurs in content-cms.
 */
export class BlogPostPublishedEvent extends DomainEvent {
  public readonly eventName = "BlogPostPublishedEvent";
  ...
  constructor(payload: BlogPostPublishedEventPayload | string) {
    super();
