...
import type { INavigationMenuRepository, INavigationMenuFilterOptions } from "../domain/INavigationMenuRepository.ts";

/**
 * InMemory Repository for NavigationMenu
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryNavigationMenuRepository extends InMemoryRepository<NavigationMenu> implements INavigationMenuRepository {
  public async findByName(name: string): Promise<NavigationMenu | null> {
  ...
  public async findByCode(code: string): Promise<NavigationMenu | null> {
  ...
  public async findFiltered(options: INavigationMenuFilterOptions = {}): Promise<NavigationMenu[]> {
  ...
  public async count(options: INavigationMenuFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: NavigationMenu[]): Promise<void> {
