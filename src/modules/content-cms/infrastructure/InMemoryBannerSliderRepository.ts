...
import type { IBannerSliderRepository, IBannerSliderFilterOptions } from "../domain/IBannerSliderRepository.ts";

/**
 * InMemory Repository for BannerSlider
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBannerSliderRepository extends InMemoryRepository<BannerSlider> implements IBannerSliderRepository {
  public async findByName(name: string): Promise<BannerSlider | null> {
  ...
  public async findByCode(code: string): Promise<BannerSlider | null> {
  ...
  public async findFiltered(options: IBannerSliderFilterOptions = {}): Promise<BannerSlider[]> {
  ...
  public async count(options: IBannerSliderFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BannerSlider[]): Promise<void> {
