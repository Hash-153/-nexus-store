...
import type { IFaqItemRepository, IFaqItemFilterOptions } from "../domain/IFaqItemRepository.ts";

/**
 * InMemory Repository for FaqItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryFaqItemRepository extends InMemoryRepository<FaqItem> implements IFaqItemRepository {
  public async findByName(name: string): Promise<FaqItem | null> {
  ...
  public async findByCode(code: string): Promise<FaqItem | null> {
  ...
  public async findFiltered(options: IFaqItemFilterOptions = {}): Promise<FaqItem[]> {
  ...
  public async count(options: IFaqItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: FaqItem[]): Promise<void> {
