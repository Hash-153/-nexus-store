...
import type { ISeoMetadataRepository, ISeoMetadataFilterOptions } from "../domain/ISeoMetadataRepository.ts";

/**
 * InMemory Repository for SeoMetadata
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySeoMetadataRepository extends InMemoryRepository<SeoMetadata> implements ISeoMetadataRepository {
  public async findByName(name: string): Promise<SeoMetadata | null> {
  ...
  public async findByCode(code: string): Promise<SeoMetadata | null> {
  ...
  public async findFiltered(options: ISeoMetadataFilterOptions = {}): Promise<SeoMetadata[]> {
  ...
  public async count(options: ISeoMetadataFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SeoMetadata[]): Promise<void> {
