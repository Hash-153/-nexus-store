...
import type { IBlogPostRepository, IBlogPostFilterOptions } from "../domain/IBlogPostRepository.ts";

/**
 * InMemory Repository for BlogPost
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBlogPostRepository extends InMemoryRepository<BlogPost> implements IBlogPostRepository {
  public async findByName(name: string): Promise<BlogPost | null> {
  ...
  public async findByCode(code: string): Promise<BlogPost | null> {
  ...
  public async findFiltered(options: IBlogPostFilterOptions = {}): Promise<BlogPost[]> {
  ...
  public async count(options: IBlogPostFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BlogPost[]): Promise<void> {
