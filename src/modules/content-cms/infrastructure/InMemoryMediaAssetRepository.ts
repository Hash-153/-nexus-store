...
import type { IMediaAssetRepository, IMediaAssetFilterOptions } from "../domain/IMediaAssetRepository.ts";

/**
 * InMemory Repository for MediaAsset
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryMediaAssetRepository extends InMemoryRepository<MediaAsset> implements IMediaAssetRepository {
  public async findByName(name: string): Promise<MediaAsset | null> {
  ...
  public async findByCode(code: string): Promise<MediaAsset | null> {
  ...
  public async findFiltered(options: IMediaAssetFilterOptions = {}): Promise<MediaAsset[]> {
  ...
  public async count(options: IMediaAssetFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: MediaAsset[]): Promise<void> {
