...
import type { IMenuItemRepository, IMenuItemFilterOptions } from "../domain/IMenuItemRepository.ts";

/**
 * InMemory Repository for MenuItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryMenuItemRepository extends InMemoryRepository<MenuItem> implements IMenuItemRepository {
  public async findByName(name: string): Promise<MenuItem | null> {
  ...
  public async findByCode(code: string): Promise<MenuItem | null> {
  ...
  public async findFiltered(options: IMenuItemFilterOptions = {}): Promise<MenuItem[]> {
  ...
  public async count(options: IMenuItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: MenuItem[]): Promise<void> {
