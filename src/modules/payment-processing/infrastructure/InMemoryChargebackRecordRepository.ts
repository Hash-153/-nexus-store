...
import type { IChargebackRecordRepository, IChargebackRecordFilterOptions } from "../domain/IChargebackRecordRepository.ts";

/**
 * InMemory Repository for ChargebackRecord
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryChargebackRecordRepository extends InMemoryRepository<ChargebackRecord> implements IChargebackRecordRepository {
  public async findByName(name: string): Promise<ChargebackRecord | null> {
  ...
  public async findByCode(code: string): Promise<ChargebackRecord | null> {
  ...
  public async findFiltered(options: IChargebackRecordFilterOptions = {}): Promise<ChargebackRecord[]> {
  ...
  public async count(options: IChargebackRecordFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ChargebackRecord[]): Promise<void> {
