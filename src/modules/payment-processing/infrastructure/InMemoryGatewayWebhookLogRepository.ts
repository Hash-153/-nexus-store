...
import type { IGatewayWebhookLogRepository, IGatewayWebhookLogFilterOptions } from "../domain/IGatewayWebhookLogRepository.ts";

/**
 * InMemory Repository for GatewayWebhookLog
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryGatewayWebhookLogRepository extends InMemoryRepository<GatewayWebhookLog> implements IGatewayWebhookLogRepository {
  public async findByName(name: string): Promise<GatewayWebhookLog | null> {
  ...
  public async findByCode(code: string): Promise<GatewayWebhookLog | null> {
  ...
  public async findFiltered(options: IGatewayWebhookLogFilterOptions = {}): Promise<GatewayWebhookLog[]> {
  ...
  public async count(options: IGatewayWebhookLogFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: GatewayWebhookLog[]): Promise<void> {
