...
import type { IPaymentTransactionRepository, IPaymentTransactionFilterOptions } from "../domain/IPaymentTransactionRepository.ts";

/**
 * InMemory Repository for PaymentTransaction
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPaymentTransactionRepository extends InMemoryRepository<PaymentTransaction> implements IPaymentTransactionRepository {
  public async findByName(name: string): Promise<PaymentTransaction | null> {
  ...
  public async findByCode(code: string): Promise<PaymentTransaction | null> {
  ...
  public async findFiltered(options: IPaymentTransactionFilterOptions = {}): Promise<PaymentTransaction[]> {
  ...
  public async count(options: IPaymentTransactionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PaymentTransaction[]): Promise<void> {
