...
import type { IEscrowAccountRepository, IEscrowAccountFilterOptions } from "../domain/IEscrowAccountRepository.ts";

/**
 * InMemory Repository for EscrowAccount
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryEscrowAccountRepository extends InMemoryRepository<EscrowAccount> implements IEscrowAccountRepository {
  public async findByName(name: string): Promise<EscrowAccount | null> {
  ...
  public async findByCode(code: string): Promise<EscrowAccount | null> {
  ...
  public async findFiltered(options: IEscrowAccountFilterOptions = {}): Promise<EscrowAccount[]> {
  ...
  public async count(options: IEscrowAccountFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: EscrowAccount[]): Promise<void> {
