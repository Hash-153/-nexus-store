...
import type { IRefundTransactionRepository, IRefundTransactionFilterOptions } from "../domain/IRefundTransactionRepository.ts";

/**
 * InMemory Repository for RefundTransaction
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRefundTransactionRepository extends InMemoryRepository<RefundTransaction> implements IRefundTransactionRepository {
  public async findByName(name: string): Promise<RefundTransaction | null> {
  ...
  public async findByCode(code: string): Promise<RefundTransaction | null> {
  ...
  public async findFiltered(options: IRefundTransactionFilterOptions = {}): Promise<RefundTransaction[]> {
  ...
  public async count(options: IRefundTransactionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RefundTransaction[]): Promise<void> {
