...
import type { IPaymentMethodRecordRepository, IPaymentMethodRecordFilterOptions } from "../domain/IPaymentMethodRecordRepository.ts";

/**
 * InMemory Repository for PaymentMethodRecord
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPaymentMethodRecordRepository extends InMemoryRepository<PaymentMethodRecord> implements IPaymentMethodRecordRepository {
  public async findByName(name: string): Promise<PaymentMethodRecord | null> {
  ...
  public async findByCode(code: string): Promise<PaymentMethodRecord | null> {
  ...
  public async findFiltered(options: IPaymentMethodRecordFilterOptions = {}): Promise<PaymentMethodRecord[]> {
  ...
  public async count(options: IPaymentMethodRecordFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PaymentMethodRecord[]): Promise<void> {
