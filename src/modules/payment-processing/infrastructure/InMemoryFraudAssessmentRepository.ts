...
import type { IFraudAssessmentRepository, IFraudAssessmentFilterOptions } from "../domain/IFraudAssessmentRepository.ts";

/**
 * InMemory Repository for FraudAssessment
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryFraudAssessmentRepository extends InMemoryRepository<FraudAssessment> implements IFraudAssessmentRepository {
  public async findByName(name: string): Promise<FraudAssessment | null> {
  ...
  public async findByCode(code: string): Promise<FraudAssessment | null> {
  ...
  public async findFiltered(options: IFraudAssessmentFilterOptions = {}): Promise<FraudAssessment[]> {
  ...
  public async count(options: IFraudAssessmentFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: FraudAssessment[]): Promise<void> {
