...
/**
 * Domain Event: PaymentAuthorizedEvent
 * Dispatched when  payment authorized event occurs in payment-processing.
 */
export class PaymentAuthorizedEvent extends DomainEvent {
  public readonly eventName = "PaymentAuthorizedEvent";
  ...
  constructor(payload: PaymentAuthorizedEventPayload | string) {
    super();
