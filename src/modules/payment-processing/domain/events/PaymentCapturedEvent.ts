...
/**
 * Domain Event: PaymentCapturedEvent
 * Dispatched when  payment captured event occurs in payment-processing.
 */
export class PaymentCapturedEvent extends DomainEvent {
  public readonly eventName = "PaymentCapturedEvent";
  ...
  constructor(payload: PaymentCapturedEventPayload | string) {
    super();
