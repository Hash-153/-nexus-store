...
/**
 * Domain Event: PaymentRefundedEvent
 * Dispatched when  payment refunded event occurs in payment-processing.
 */
export class PaymentRefundedEvent extends DomainEvent {
  ...
  constructor(payload: PaymentRefundedEventPayload | string) {
    super();
