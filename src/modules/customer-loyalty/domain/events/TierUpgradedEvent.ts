...
export interface TierUpgradedEventPayload {
...
/**
 * Domain Event: TierUpgradedEvent
 * Dispatched when  tier upgraded event occurs in customer-loyalty.
 */
export class TierUpgradedEvent extends DomainEvent {
  public readonly eventName = "TierUpgradedEvent";
  ...
  constructor(payload: TierUpgradedEventPayload | string) {
    super();
