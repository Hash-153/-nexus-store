...
export interface PointsAwardedEventPayload {
...
/**
 * Domain Event: PointsAwardedEvent
 * Dispatched when  points awarded event occurs in customer-loyalty.
 */
export class PointsAwardedEvent extends DomainEvent {
  public readonly eventName = "PointsAwardedEvent";
  ...
  constructor(payload: PointsAwardedEventPayload | string) {
    super();
