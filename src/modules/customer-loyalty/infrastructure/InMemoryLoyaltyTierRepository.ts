...
import type { ILoyaltyTierRepository, ILoyaltyTierFilterOptions } from "../domain/ILoyaltyTierRepository.ts";

/**
 * InMemory Repository for LoyaltyTier
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryLoyaltyTierRepository extends InMemoryRepository<LoyaltyTier> implements ILoyaltyTierRepository {
  public async findByName(name: string): Promise<LoyaltyTier | null> {
  ...
  public async findByCode(code: string): Promise<LoyaltyTier | null> {
  ...
  public async findFiltered(options: ILoyaltyTierFilterOptions = {}): Promise<LoyaltyTier[]> {
  ...
  public async count(options: ILoyaltyTierFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: LoyaltyTier[]): Promise<void> {
