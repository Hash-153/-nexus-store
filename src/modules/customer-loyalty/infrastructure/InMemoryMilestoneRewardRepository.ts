...
import type { IMilestoneRewardRepository, IMilestoneRewardFilterOptions } from "../domain/IMilestoneRewardRepository.ts";

/**
 * InMemory Repository for MilestoneReward
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryMilestoneRewardRepository extends InMemoryRepository<MilestoneReward> implements IMilestoneRewardRepository {
  public async findByName(name: string): Promise<MilestoneReward | null> {
  ...
  public async findByCode(code: string): Promise<MilestoneReward | null> {
  ...
  public async findFiltered(options: IMilestoneRewardFilterOptions = {}): Promise<MilestoneReward[]> {
  ...
  public async count(options: IMilestoneRewardFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: MilestoneReward[]): Promise<void> {
