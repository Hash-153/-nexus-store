...
import type { IRewardVoucherRepository, IRewardVoucherFilterOptions } from "../domain/IRewardVoucherRepository.ts";

/**
 * InMemory Repository for RewardVoucher
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRewardVoucherRepository extends InMemoryRepository<RewardVoucher> implements IRewardVoucherRepository {
  public async findByName(name: string): Promise<RewardVoucher | null> {
  ...
  public async findByCode(code: string): Promise<RewardVoucher | null> {
  ...
  public async findFiltered(options: IRewardVoucherFilterOptions = {}): Promise<RewardVoucher[]> {
  ...
  public async count(options: IRewardVoucherFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RewardVoucher[]): Promise<void> {
