...
import type { IReferralRecordRepository, IReferralRecordFilterOptions } from "../domain/IReferralRecordRepository.ts";

/**
 * InMemory Repository for ReferralRecord
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryReferralRecordRepository extends InMemoryRepository<ReferralRecord> implements IReferralRecordRepository {
  public async findByName(name: string): Promise<ReferralRecord | null> {
  ...
  public async findByCode(code: string): Promise<ReferralRecord | null> {
  ...
  public async findFiltered(options: IReferralRecordFilterOptions = {}): Promise<ReferralRecord[]> {
  ...
  public async count(options: IReferralRecordFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ReferralRecord[]): Promise<void> {
