...
export interface ShipmentInTransitEventPayload {
...
/**
 * Domain Event: ShipmentInTransitEvent
 * Dispatched when  shipment in transit event occurs in shipping-logistics.
 */
export class ShipmentInTransitEvent extends DomainEvent {
  public readonly eventName = "ShipmentInTransitEvent";
  ...
  constructor(payload: ShipmentInTransitEventPayload | string) {
    super();
