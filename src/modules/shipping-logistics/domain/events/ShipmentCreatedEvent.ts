...
/**
 * Domain Event: ShipmentCreatedEvent
 * Dispatched when  shipment created event occurs in shipping-logistics.
 */
export class ShipmentCreatedEvent extends DomainEvent {
  public readonly eventName = "ShipmentCreatedEvent";
  ...
  constructor(payload: ShipmentCreatedEventPayload | string) {
    super();
