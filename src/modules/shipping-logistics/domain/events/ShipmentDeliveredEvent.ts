...
/**
 * Domain Event: ShipmentDeliveredEvent
 * Dispatched when  shipment delivered event occurs in shipping-logistics.
 */
export class ShipmentDeliveredEvent extends DomainEvent {
  public readonly eventName = "ShipmentDeliveredEvent";
  ...
  constructor(payload: ShipmentDeliveredEventPayload | string) {
    super();
