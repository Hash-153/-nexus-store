...
export interface ShipmentFailedEventPayload {
...
/**
 * Domain Event: ShipmentFailedEvent
 * Dispatched when  shipment failed event occurs in shipping-logistics.
 */
export class ShipmentFailedEvent extends DomainEvent {
  public readonly eventName = "ShipmentFailedEvent";
  ...
  constructor(payload: ShipmentFailedEventPayload | string) {
    super();
