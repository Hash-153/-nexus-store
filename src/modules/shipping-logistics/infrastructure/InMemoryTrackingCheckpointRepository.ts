...
import type { ITrackingCheckpointRepository, ITrackingCheckpointFilterOptions } from "../domain/ITrackingCheckpointRepository.ts";

/**
 * InMemory Repository for TrackingCheckpoint
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTrackingCheckpointRepository extends InMemoryRepository<TrackingCheckpoint> implements ITrackingCheckpointRepository {
  public async findByName(name: string): Promise<TrackingCheckpoint | null> {
  ...
  public async findByCode(code: string): Promise<TrackingCheckpoint | null> {
  ...
  public async findFiltered(options: ITrackingCheckpointFilterOptions = {}): Promise<TrackingCheckpoint[]> {
  ...
  public async count(options: ITrackingCheckpointFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TrackingCheckpoint[]): Promise<void> {
