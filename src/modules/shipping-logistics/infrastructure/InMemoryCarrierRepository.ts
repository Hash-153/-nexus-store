...
import type { ICarrierRepository, ICarrierFilterOptions } from "../domain/ICarrierRepository.ts";

/**
 * InMemory Repository for Carrier
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCarrierRepository extends InMemoryRepository<Carrier> implements ICarrierRepository {
  public async findByName(name: string): Promise<Carrier | null> {
  ...
  public async findByCode(code: string): Promise<Carrier | null> {
  ...
  public async findFiltered(options: ICarrierFilterOptions = {}): Promise<Carrier[]> {
  ...
  public async count(options: ICarrierFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: Carrier[]): Promise<void> {
