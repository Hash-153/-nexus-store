...
import type { IPickupLocationRepository, IPickupLocationFilterOptions } from "../domain/IPickupLocationRepository.ts";

/**
 * InMemory Repository for PickupLocation
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPickupLocationRepository extends InMemoryRepository<PickupLocation> implements IPickupLocationRepository {
  public async findByName(name: string): Promise<PickupLocation | null> {
  ...
  public async findByCode(code: string): Promise<PickupLocation | null> {
  ...
  public async findFiltered(options: IPickupLocationFilterOptions = {}): Promise<PickupLocation[]> {
  ...
  public async count(options: IPickupLocationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PickupLocation[]): Promise<void> {
