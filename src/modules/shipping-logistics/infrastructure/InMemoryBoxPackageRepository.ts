...
import type { IBoxPackageRepository, IBoxPackageFilterOptions } from "../domain/IBoxPackageRepository.ts";

/**
 * InMemory Repository for BoxPackage
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBoxPackageRepository extends InMemoryRepository<BoxPackage> implements IBoxPackageRepository {
  public async findByName(name: string): Promise<BoxPackage | null> {
  ...
  public async findByCode(code: string): Promise<BoxPackage | null> {
  ...
  public async findFiltered(options: IBoxPackageFilterOptions = {}): Promise<BoxPackage[]> {
  ...
  public async count(options: IBoxPackageFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BoxPackage[]): Promise<void> {
