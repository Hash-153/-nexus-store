...
import type { IDeliverySlotRepository, IDeliverySlotFilterOptions } from "../domain/IDeliverySlotRepository.ts";

/**
 * InMemory Repository for DeliverySlot
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryDeliverySlotRepository extends InMemoryRepository<DeliverySlot> implements IDeliverySlotRepository {
  public async findByName(name: string): Promise<DeliverySlot | null> {
  ...
  public async findByCode(code: string): Promise<DeliverySlot | null> {
  ...
  public async findFiltered(options: IDeliverySlotFilterOptions = {}): Promise<DeliverySlot[]> {
  ...
  public async count(options: IDeliverySlotFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: DeliverySlot[]): Promise<void> {
