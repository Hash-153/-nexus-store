...
import type { IRateTableRepository, IRateTableFilterOptions } from "../domain/IRateTableRepository.ts";

/**
 * InMemory Repository for RateTable
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRateTableRepository extends InMemoryRepository<RateTable> implements IRateTableRepository {
  public async findByName(name: string): Promise<RateTable | null> {
  ...
  public async findByCode(code: string): Promise<RateTable | null> {
  ...
  public async findFiltered(options: IRateTableFilterOptions = {}): Promise<RateTable[]> {
  ...
  public async count(options: IRateTableFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RateTable[]): Promise<void> {
