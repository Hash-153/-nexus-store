...
import type { IShippingZoneRepository, IShippingZoneFilterOptions } from "../domain/IShippingZoneRepository.ts";

/**
 * InMemory Repository for ShippingZone
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryShippingZoneRepository extends InMemoryRepository<ShippingZone> implements IShippingZoneRepository {
  public async findByName(name: string): Promise<ShippingZone | null> {
  ...
  public async findByCode(code: string): Promise<ShippingZone | null> {
  ...
  public async findFiltered(options: IShippingZoneFilterOptions = {}): Promise<ShippingZone[]> {
  ...
  public async count(options: IShippingZoneFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ShippingZone[]): Promise<void> {
