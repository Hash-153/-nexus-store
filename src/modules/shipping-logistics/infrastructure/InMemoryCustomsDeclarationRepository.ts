...
import type { ICustomsDeclarationRepository, ICustomsDeclarationFilterOptions } from "../domain/ICustomsDeclarationRepository.ts";

/**
 * InMemory Repository for CustomsDeclaration
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCustomsDeclarationRepository extends InMemoryRepository<CustomsDeclaration> implements ICustomsDeclarationRepository {
  public async findByName(name: string): Promise<CustomsDeclaration | null> {
  ...
  public async findByCode(code: string): Promise<CustomsDeclaration | null> {
  ...
  public async findFiltered(options: ICustomsDeclarationFilterOptions = {}): Promise<CustomsDeclaration[]> {
  ...
  public async count(options: ICustomsDeclarationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CustomsDeclaration[]): Promise<void> {
