...
import type { ITransferOrderRepository, ITransferOrderFilterOptions } from "../domain/ITransferOrderRepository.ts";

/**
 * InMemory Repository for TransferOrder
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTransferOrderRepository extends InMemoryRepository<TransferOrder> implements ITransferOrderRepository {
  public async findByName(name: string): Promise<TransferOrder | null> {
  ...
  public async findByCode(code: string): Promise<TransferOrder | null> {
  ...
  public async findFiltered(options: ITransferOrderFilterOptions = {}): Promise<TransferOrder[]> {
  ...
  public async count(options: ITransferOrderFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TransferOrder[]): Promise<void> {
