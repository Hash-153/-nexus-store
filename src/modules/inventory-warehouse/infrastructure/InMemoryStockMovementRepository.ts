...
import type { IStockMovementRepository, IStockMovementFilterOptions } from "../domain/IStockMovementRepository.ts";

/**
 * InMemory Repository for StockMovement
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryStockMovementRepository extends InMemoryRepository<StockMovement> implements IStockMovementRepository {
  public async findByName(name: string): Promise<StockMovement | null> {
  ...
  public async findByCode(code: string): Promise<StockMovement | null> {
  ...
  public async findFiltered(options: IStockMovementFilterOptions = {}): Promise<StockMovement[]> {
  ...
  public async count(options: IStockMovementFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: StockMovement[]): Promise<void> {
