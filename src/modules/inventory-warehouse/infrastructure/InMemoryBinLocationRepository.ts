...
import type { IBinLocationRepository, IBinLocationFilterOptions } from "../domain/IBinLocationRepository.ts";

/**
 * InMemory Repository for BinLocation
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryBinLocationRepository extends InMemoryRepository<BinLocation> implements IBinLocationRepository {
  public async findByName(name: string): Promise<BinLocation | null> {
  ...
  public async findByCode(code: string): Promise<BinLocation | null> {
  ...
  public async findFiltered(options: IBinLocationFilterOptions = {}): Promise<BinLocation[]> {
  ...
  public async count(options: IBinLocationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: BinLocation[]): Promise<void> {
