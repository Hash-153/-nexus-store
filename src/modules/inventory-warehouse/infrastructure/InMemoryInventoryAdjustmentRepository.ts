...
import type { IInventoryAdjustmentRepository, IInventoryAdjustmentFilterOptions } from "../domain/IInventoryAdjustmentRepository.ts";

/**
 * InMemory Repository for InventoryAdjustment
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryInventoryAdjustmentRepository extends InMemoryRepository<InventoryAdjustment> implements IInventoryAdjustmentRepository {
  public async findByName(name: string): Promise<InventoryAdjustment | null> {
  ...
  public async findByCode(code: string): Promise<InventoryAdjustment | null> {
  ...
  public async findFiltered(options: IInventoryAdjustmentFilterOptions = {}): Promise<InventoryAdjustment[]> {
  ...
  public async count(options: IInventoryAdjustmentFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: InventoryAdjustment[]): Promise<void> {
