...
import type { IInventoryItemRepository, IInventoryItemFilterOptions } from "../domain/IInventoryItemRepository.ts";

/**
 * InMemory Repository for InventoryItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryInventoryItemRepository extends InMemoryRepository<InventoryItem> implements IInventoryItemRepository {
  public async findByName(name: string): Promise<InventoryItem | null> {
  ...
  public async findByCode(code: string): Promise<InventoryItem | null> {
  ...
  public async findFiltered(options: IInventoryItemFilterOptions = {}): Promise<InventoryItem[]> {
  ...
  public async count(options: IInventoryItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: InventoryItem[]): Promise<void> {
