...
import type { IRestockOrderRepository, IRestockOrderFilterOptions } from "../domain/IRestockOrderRepository.ts";

/**
 * InMemory Repository for RestockOrder
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRestockOrderRepository extends InMemoryRepository<RestockOrder> implements IRestockOrderRepository {
  public async findByName(name: string): Promise<RestockOrder | null> {
  ...
  public async findByCode(code: string): Promise<RestockOrder | null> {
  ...
  public async findFiltered(options: IRestockOrderFilterOptions = {}): Promise<RestockOrder[]> {
  ...
  public async count(options: IRestockOrderFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RestockOrder[]): Promise<void> {
