...
import type { ILotBatchRepository, ILotBatchFilterOptions } from "../domain/ILotBatchRepository.ts";

/**
 * InMemory Repository for LotBatch
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryLotBatchRepository extends InMemoryRepository<LotBatch> implements ILotBatchRepository {
  public async findByName(name: string): Promise<LotBatch | null> {
  ...
  public async findByCode(code: string): Promise<LotBatch | null> {
  ...
  public async findFiltered(options: ILotBatchFilterOptions = {}): Promise<LotBatch[]> {
  ...
  public async count(options: ILotBatchFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: LotBatch[]): Promise<void> {
