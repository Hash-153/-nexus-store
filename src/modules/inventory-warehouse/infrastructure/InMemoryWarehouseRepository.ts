...
import type { IWarehouseRepository, IWarehouseFilterOptions } from "../domain/IWarehouseRepository.ts";

/**
 * InMemory Repository for Warehouse
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryWarehouseRepository extends InMemoryRepository<Warehouse> implements IWarehouseRepository {
  ...
  public async findFiltered(options: IWarehouseFilterOptions = {}): Promise<Warehouse[]> {
  ...
  public async count(options: IWarehouseFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: Warehouse[]): Promise<void> {
