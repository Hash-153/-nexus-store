...
/**
 * Domain Aggregate Root: Warehouse
 * Encapsulates state and business invariants for Warehouse within inventory-warehouse.
 */
export class Warehouse extends AggregateRoot<WarehouseProps> {
  private _versionNumber: number = 1;

  public constructor(props: WarehouseProps, id?: string, createdAt?: Date, updatedAt?: Date) {
  ...
  public static create(props: WarehouseProps, id?: string): Warehouse {
    ...
    if (props.code !== undefined && props.code.trim().length === 0) {
      throw new ValidationError("Warehouse code cannot be empty.");
    }
  ...
  public static reconstitute(props: WarehouseProps, id: string, createdAt: Date, updatedAt: Date): Warehouse {
    return new Warehouse(props, id, createdAt, updatedAt);
  }

  public updateDetails(updates: Partial<WarehouseProps>): void {
