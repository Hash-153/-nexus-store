...
export interface LowStockDetectedEventPayload {
...
/**
 * Domain Event: LowStockDetectedEvent
 * Dispatched when  low stock detected event occurs in inventory-warehouse.
 */
export class LowStockDetectedEvent extends DomainEvent {
  public readonly eventName = "LowStockDetectedEvent";
  ...
  constructor(payload: LowStockDetectedEventPayload | string) {
    super();
