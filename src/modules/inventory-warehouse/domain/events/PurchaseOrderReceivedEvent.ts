...
export interface PurchaseOrderReceivedEventPayload {
...
/**
 * Domain Event: PurchaseOrderReceivedEvent
 * Dispatched when  purchase order received event occurs in inventory-warehouse.
 */
export class PurchaseOrderReceivedEvent extends DomainEvent {
  public readonly eventName = "PurchaseOrderReceivedEvent";
  ...
  constructor(payload: PurchaseOrderReceivedEventPayload | string) {
    super();
