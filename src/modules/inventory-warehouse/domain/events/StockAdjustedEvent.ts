...
export interface StockAdjustedEventPayload {
 ...
 * Dispatched when  stock adjusted event occurs in inventory-warehouse.
 */
export class StockAdjustedEvent extends DomainEvent {
  public readonly eventName = "StockAdjustedEvent";
  ...
  constructor(payload: StockAdjustedEventPayload | string) {
    super();
