...
export interface StockReservedEventPayload {
...
/**
 * Domain Event: StockReservedEvent
 * Dispatched when  stock reserved event occurs in inventory-warehouse.
 */
export class StockReservedEvent extends DomainEvent {
  public readonly eventName = "StockReservedEvent";
  ...
  constructor(payload: StockReservedEventPayload | string) {
    super();
