...
import type { ISupportAgentProfileRepository, ISupportAgentProfileFilterOptions } from "../domain/ISupportAgentProfileRepository.ts";

/**
 * InMemory Repository for SupportAgentProfile
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySupportAgentProfileRepository extends InMemoryRepository<SupportAgentProfile> implements ISupportAgentProfileRepository {
  public async findByName(name: string): Promise<SupportAgentProfile | null> {
  ...
  public async findByCode(code: string): Promise<SupportAgentProfile | null> {
  ...
  public async findFiltered(options: ISupportAgentProfileFilterOptions = {}): Promise<SupportAgentProfile[]> {
  ...
  public async count(options: ISupportAgentProfileFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SupportAgentProfile[]): Promise<void> {
