...
import type { ICannedResponseRepository, ICannedResponseFilterOptions } from "../domain/ICannedResponseRepository.ts";

/**
 * InMemory Repository for CannedResponse
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCannedResponseRepository extends InMemoryRepository<CannedResponse> implements ICannedResponseRepository {
  public async findByName(name: string): Promise<CannedResponse | null> {
  ...
  public async findByCode(code: string): Promise<CannedResponse | null> {
  ...
  public async findFiltered(options: ICannedResponseFilterOptions = {}): Promise<CannedResponse[]> {
  ...
  public async count(options: ICannedResponseFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CannedResponse[]): Promise<void> {
