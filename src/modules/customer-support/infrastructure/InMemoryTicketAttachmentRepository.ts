...
import type { ITicketAttachmentRepository, ITicketAttachmentFilterOptions } from "../domain/ITicketAttachmentRepository.ts";

/**
 * InMemory Repository for TicketAttachment
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTicketAttachmentRepository extends InMemoryRepository<TicketAttachment> implements ITicketAttachmentRepository {
  public async findByName(name: string): Promise<TicketAttachment | null> {
  ...
  public async findByCode(code: string): Promise<TicketAttachment | null> {
  ...
  public async findFiltered(options: ITicketAttachmentFilterOptions = {}): Promise<TicketAttachment[]> {
  ...
  public async count(options: ITicketAttachmentFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TicketAttachment[]): Promise<void> {
