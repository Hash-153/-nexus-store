...
import type { ISlaPolicyRepository, ISlaPolicyFilterOptions } from "../domain/ISlaPolicyRepository.ts";

/**
 * InMemory Repository for SlaPolicy
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySlaPolicyRepository extends InMemoryRepository<SlaPolicy> implements ISlaPolicyRepository {
  public async findByName(name: string): Promise<SlaPolicy | null> {
  ...
  public async findByCode(code: string): Promise<SlaPolicy | null> {
  ...
  public async findFiltered(options: ISlaPolicyFilterOptions = {}): Promise<SlaPolicy[]> {
  ...
  public async count(options: ISlaPolicyFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SlaPolicy[]): Promise<void> {
