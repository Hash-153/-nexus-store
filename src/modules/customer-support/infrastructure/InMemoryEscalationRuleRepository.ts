...
import type { IEscalationRuleRepository, IEscalationRuleFilterOptions } from "../domain/IEscalationRuleRepository.ts";

/**
 * InMemory Repository for EscalationRule
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryEscalationRuleRepository extends InMemoryRepository<EscalationRule> implements IEscalationRuleRepository {
  public async findByName(name: string): Promise<EscalationRule | null> {
  ...
  public async findByCode(code: string): Promise<EscalationRule | null> {
  ...
  public async findFiltered(options: IEscalationRuleFilterOptions = {}): Promise<EscalationRule[]> {
  ...
  public async count(options: IEscalationRuleFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: EscalationRule[]): Promise<void> {
