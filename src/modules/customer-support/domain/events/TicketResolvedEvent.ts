...
/**
 * Domain Event: TicketResolvedEvent
 * Dispatched when  ticket resolved event occurs in customer-support.
 */
export class TicketResolvedEvent extends DomainEvent {
  public readonly eventName = "TicketResolvedEvent";
  ...
  constructor(payload: TicketResolvedEventPayload | string) {
    super();
