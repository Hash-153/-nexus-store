 ...
 * Dispatched when  ticket assigned event occurs in customer-support.
 */
export class TicketAssignedEvent extends DomainEvent {
  public readonly eventName = "TicketAssignedEvent";
  ...
  constructor(payload: TicketAssignedEventPayload | string) {
    super();
