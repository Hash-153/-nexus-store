...
/**
 * Domain Event: SlaBreachedEvent
 * Dispatched when  sla breached event occurs in customer-support.
 */
export class SlaBreachedEvent extends DomainEvent {
  public readonly eventName = "SlaBreachedEvent";
  ...
  constructor(payload: SlaBreachedEventPayload | string) {
    super();
