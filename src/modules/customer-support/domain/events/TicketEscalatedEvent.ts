...
export interface TicketEscalatedEventPayload {
...
/**
 * Domain Event: TicketEscalatedEvent
 * Dispatched when  ticket escalated event occurs in customer-support.
 */
export class TicketEscalatedEvent extends DomainEvent {
  public readonly eventName = "TicketEscalatedEvent";
  ...
  constructor(payload: TicketEscalatedEventPayload | string) {
    super();
