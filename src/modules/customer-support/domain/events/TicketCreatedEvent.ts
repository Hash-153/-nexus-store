...
/**
 * Domain Event: TicketCreatedEvent
 * Dispatched when  ticket created event occurs in customer-support.
 */
export class TicketCreatedEvent extends DomainEvent {
  public readonly eventName = "TicketCreatedEvent";
  ...
  constructor(payload: TicketCreatedEventPayload | string) {
    super();
