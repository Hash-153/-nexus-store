...
export interface CartAbandonedEventPayload {
...
/**
 * Domain Event: CartAbandonedEvent
 * Dispatched when  cart abandoned event occurs in cart-checkout.
 */
export class CartAbandonedEvent extends DomainEvent {
  ...
  constructor(payload: CartAbandonedEventPayload | string) {
    super();
