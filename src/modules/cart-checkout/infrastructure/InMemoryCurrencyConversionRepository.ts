...
import type { ICurrencyConversionRepository, ICurrencyConversionFilterOptions } from "../domain/ICurrencyConversionRepository.ts";

/**
 * InMemory Repository for CurrencyConversion
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCurrencyConversionRepository extends InMemoryRepository<CurrencyConversion> implements ICurrencyConversionRepository {
  public async findByName(name: string): Promise<CurrencyConversion | null> {
  ...
  public async findByCode(code: string): Promise<CurrencyConversion | null> {
  ...
  public async findFiltered(options: ICurrencyConversionFilterOptions = {}): Promise<CurrencyConversion[]> {
  ...
  public async count(options: ICurrencyConversionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CurrencyConversion[]): Promise<void> {
