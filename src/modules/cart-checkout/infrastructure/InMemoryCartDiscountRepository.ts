...
import type { ICartDiscountRepository, ICartDiscountFilterOptions } from "../domain/ICartDiscountRepository.ts";

/**
 * InMemory Repository for CartDiscount
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCartDiscountRepository extends InMemoryRepository<CartDiscount> implements ICartDiscountRepository {
  public async findByName(name: string): Promise<CartDiscount | null> {
  ...
  public async findByCode(code: string): Promise<CartDiscount | null> {
  ...
  public async findFiltered(options: ICartDiscountFilterOptions = {}): Promise<CartDiscount[]> {
  ...
  public async count(options: ICartDiscountFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CartDiscount[]): Promise<void> {
