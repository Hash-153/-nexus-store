...
import type { ITaxBreakdownRepository, ITaxBreakdownFilterOptions } from "../domain/ITaxBreakdownRepository.ts";

/**
 * InMemory Repository for TaxBreakdown
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTaxBreakdownRepository extends InMemoryRepository<TaxBreakdown> implements ITaxBreakdownRepository {
  public async findByName(name: string): Promise<TaxBreakdown | null> {
  ...
  public async findByCode(code: string): Promise<TaxBreakdown | null> {
  ...
  public async findFiltered(options: ITaxBreakdownFilterOptions = {}): Promise<TaxBreakdown[]> {
  ...
  public async count(options: ITaxBreakdownFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TaxBreakdown[]): Promise<void> {
