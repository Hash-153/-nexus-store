...
import type { ICheckoutSessionRepository, ICheckoutSessionFilterOptions } from "../domain/ICheckoutSessionRepository.ts";

/**
 * InMemory Repository for CheckoutSession
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCheckoutSessionRepository extends InMemoryRepository<CheckoutSession> implements ICheckoutSessionRepository {
  public async findByName(name: string): Promise<CheckoutSession | null> {
  ...
  public async findByCode(code: string): Promise<CheckoutSession | null> {
  ...
  public async findFiltered(options: ICheckoutSessionFilterOptions = {}): Promise<CheckoutSession[]> {
  ...
  public async count(options: ICheckoutSessionFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CheckoutSession[]): Promise<void> {
