...
import type { ISavedForLaterItemRepository, ISavedForLaterItemFilterOptions } from "../domain/ISavedForLaterItemRepository.ts";

/**
 * InMemory Repository for SavedForLaterItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySavedForLaterItemRepository extends InMemoryRepository<SavedForLaterItem> implements ISavedForLaterItemRepository {
  public async findByName(name: string): Promise<SavedForLaterItem | null> {
  ...
  public async findByCode(code: string): Promise<SavedForLaterItem | null> {
  ...
  public async findFiltered(options: ISavedForLaterItemFilterOptions = {}): Promise<SavedForLaterItem[]> {
  ...
  public async count(options: ISavedForLaterItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SavedForLaterItem[]): Promise<void> {
