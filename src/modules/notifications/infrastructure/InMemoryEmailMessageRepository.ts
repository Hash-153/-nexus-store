...
import type { IEmailMessageRepository, IEmailMessageFilterOptions } from "../domain/IEmailMessageRepository.ts";

/**
 * InMemory Repository for EmailMessage
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryEmailMessageRepository extends InMemoryRepository<EmailMessage> implements IEmailMessageRepository {
  public async findByName(name: string): Promise<EmailMessage | null> {
  ...
  public async findByCode(code: string): Promise<EmailMessage | null> {
  ...
  public async findFiltered(options: IEmailMessageFilterOptions = {}): Promise<EmailMessage[]> {
  ...
  public async count(options: IEmailMessageFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: EmailMessage[]): Promise<void> {
