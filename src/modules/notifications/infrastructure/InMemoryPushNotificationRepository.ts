...
import type { IPushNotificationRepository, IPushNotificationFilterOptions } from "../domain/IPushNotificationRepository.ts";

/**
 * InMemory Repository for PushNotification
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPushNotificationRepository extends InMemoryRepository<PushNotification> implements IPushNotificationRepository {
  public async findByName(name: string): Promise<PushNotification | null> {
  ...
  public async findByCode(code: string): Promise<PushNotification | null> {
  ...
  public async findFiltered(options: IPushNotificationFilterOptions = {}): Promise<PushNotification[]> {
  ...
  public async count(options: IPushNotificationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PushNotification[]): Promise<void> {
