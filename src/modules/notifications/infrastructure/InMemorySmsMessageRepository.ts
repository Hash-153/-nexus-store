...
import type { ISmsMessageRepository, ISmsMessageFilterOptions } from "../domain/ISmsMessageRepository.ts";

/**
 * InMemory Repository for SmsMessage
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemorySmsMessageRepository extends InMemoryRepository<SmsMessage> implements ISmsMessageRepository {
  public async findByName(name: string): Promise<SmsMessage | null> {
  ...
  public async findByCode(code: string): Promise<SmsMessage | null> {
  ...
  public async findFiltered(options: ISmsMessageFilterOptions = {}): Promise<SmsMessage[]> {
  ...
  public async count(options: ISmsMessageFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: SmsMessage[]): Promise<void> {
