...
import type { IWebhookNotificationRepository, IWebhookNotificationFilterOptions } from "../domain/IWebhookNotificationRepository.ts";

/**
 * InMemory Repository for WebhookNotification
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryWebhookNotificationRepository extends InMemoryRepository<WebhookNotification> implements IWebhookNotificationRepository {
  public async findByName(name: string): Promise<WebhookNotification | null> {
  ...
  public async findByCode(code: string): Promise<WebhookNotification | null> {
  ...
  public async findFiltered(options: IWebhookNotificationFilterOptions = {}): Promise<WebhookNotification[]> {
  ...
  public async count(options: IWebhookNotificationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: WebhookNotification[]): Promise<void> {
