...
import type { INotificationTemplateRepository, INotificationTemplateFilterOptions } from "../domain/INotificationTemplateRepository.ts";

/**
 * InMemory Repository for NotificationTemplate
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryNotificationTemplateRepository extends InMemoryRepository<NotificationTemplate> implements INotificationTemplateRepository {
  public async findByName(name: string): Promise<NotificationTemplate | null> {
  ...
  public async findByCode(code: string): Promise<NotificationTemplate | null> {
  ...
  public async findFiltered(options: INotificationTemplateFilterOptions = {}): Promise<NotificationTemplate[]> {
  ...
  public async count(options: INotificationTemplateFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: NotificationTemplate[]): Promise<void> {
