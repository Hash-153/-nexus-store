...
import type { IUserPreferenceRepository, IUserPreferenceFilterOptions } from "../domain/IUserPreferenceRepository.ts";

/**
 * InMemory Repository for UserPreference
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryUserPreferenceRepository extends InMemoryRepository<UserPreference> implements IUserPreferenceRepository {
  public async findByName(name: string): Promise<UserPreference | null> {
  ...
  public async findByCode(code: string): Promise<UserPreference | null> {
  ...
  public async findFiltered(options: IUserPreferenceFilterOptions = {}): Promise<UserPreference[]> {
  ...
  public async count(options: IUserPreferenceFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: UserPreference[]): Promise<void> {
