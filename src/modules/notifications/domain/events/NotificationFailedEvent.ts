...
/**
 * Domain Event: NotificationFailedEvent
 * Dispatched when  notification failed event occurs in notifications.
 */
export class NotificationFailedEvent extends DomainEvent {
  ...
  constructor(payload: NotificationFailedEventPayload | string) {
    super();
