...
export interface NotificationSentEventPayload {
 ...
 * Dispatched when  notification sent event occurs in notifications.
 */
export class NotificationSentEvent extends DomainEvent {
  ...
  constructor(payload: NotificationSentEventPayload | string) {
    super();
