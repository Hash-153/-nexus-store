...
export interface PreferencesUpdatedEventPayload {
...
/**
 * Domain Event: PreferencesUpdatedEvent
 * Dispatched when  preferences updated event occurs in notifications.
 */
export class PreferencesUpdatedEvent extends DomainEvent {
  public readonly eventName = "PreferencesUpdatedEvent";
  ...
  constructor(payload: PreferencesUpdatedEventPayload | string) {
    super();
