...
import type { IPasswordResetTokenRepository, IPasswordResetTokenFilterOptions } from "../domain/IPasswordResetTokenRepository.ts";

/**
 * InMemory Repository for PasswordResetToken
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryPasswordResetTokenRepository extends InMemoryRepository<PasswordResetToken> implements IPasswordResetTokenRepository {
  public async findByName(name: string): Promise<PasswordResetToken | null> {
  ...
  public async findByCode(code: string): Promise<PasswordResetToken | null> {
  ...
  public async findFiltered(options: IPasswordResetTokenFilterOptions = {}): Promise<PasswordResetToken[]> {
  ...
  public async count(options: IPasswordResetTokenFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: PasswordResetToken[]): Promise<void> {
