...
import type { IAuditLogRepository, IAuditLogFilterOptions } from "../domain/IAuditLogRepository.ts";

/**
 * InMemory Repository for AuditLog
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryAuditLogRepository extends InMemoryRepository<AuditLog> implements IAuditLogRepository {
  public async findByName(name: string): Promise<AuditLog | null> {
  ...
  public async findByCode(code: string): Promise<AuditLog | null> {
  ...
  public async findFiltered(options: IAuditLogFilterOptions = {}): Promise<AuditLog[]> {
  ...
  public async count(options: IAuditLogFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: AuditLog[]): Promise<void> {
