...
import type { IAddressBookRepository, IAddressBookFilterOptions } from "../domain/IAddressBookRepository.ts";

/**
 * InMemory Repository for AddressBook
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryAddressBookRepository extends InMemoryRepository<AddressBook> implements IAddressBookRepository {
  public async findByName(name: string): Promise<AddressBook | null> {
  ...
  public async findByCode(code: string): Promise<AddressBook | null> {
  ...
  public async findFiltered(options: IAddressBookFilterOptions = {}): Promise<AddressBook[]> {
  ...
  public async count(options: IAddressBookFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: AddressBook[]): Promise<void> {
