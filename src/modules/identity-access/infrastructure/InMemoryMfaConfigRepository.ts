...
import type { IMfaConfigRepository, IMfaConfigFilterOptions } from "../domain/IMfaConfigRepository.ts";

/**
 * InMemory Repository for MfaConfig
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryMfaConfigRepository extends InMemoryRepository<MfaConfig> implements IMfaConfigRepository {
  public async findByName(name: string): Promise<MfaConfig | null> {
  ...
  public async findByCode(code: string): Promise<MfaConfig | null> {
  ...
  public async findFiltered(options: IMfaConfigFilterOptions = {}): Promise<MfaConfig[]> {
  ...
  public async count(options: IMfaConfigFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: MfaConfig[]): Promise<void> {
