...
export interface RoleAssignedEventPayload {
...
/**
 * Domain Event: RoleAssignedEvent
 * Dispatched when  role assigned event occurs in identity-access.
 */
export class RoleAssignedEvent extends DomainEvent {
  public readonly eventName = "RoleAssignedEvent";
  ...
  constructor(payload: RoleAssignedEventPayload | string) {
    super();
