...
/**
 * Domain Event: PasswordChangedEvent
 * Dispatched when  password changed event occurs in identity-access.
 */
export class PasswordChangedEvent extends DomainEvent {
  ...
  constructor(payload: PasswordChangedEventPayload | string) {
    super();
