...
export interface MfaEnabledEventPayload {
...
/**
 * Domain Event: MfaEnabledEvent
 * Dispatched when  mfa enabled event occurs in identity-access.
 */
export class MfaEnabledEvent extends DomainEvent {
  public readonly eventName = "MfaEnabledEvent";
  ...
  constructor(payload: MfaEnabledEventPayload | string) {
    super();
