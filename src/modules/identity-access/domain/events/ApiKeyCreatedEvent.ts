...
export interface ApiKeyCreatedEventPayload {
...
/**
 * Domain Event: ApiKeyCreatedEvent
 * Dispatched when  api key created event occurs in identity-access.
 */
export class ApiKeyCreatedEvent extends DomainEvent {
  public readonly eventName = "ApiKeyCreatedEvent";
  ...
  constructor(payload: ApiKeyCreatedEventPayload | string) {
    super();
