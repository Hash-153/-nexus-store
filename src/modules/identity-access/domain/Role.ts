...
/**
 * Domain Entity: Role
 * Encapsulates state and business invariants for Role within identity-access.
 */
export class Role extends Entity<RoleProps> {
  private _versionNumber: number = 1;

  public constructor(props: RoleProps, id?: string, createdAt?: Date, updatedAt?: Date) {
  ...
  public static create(props: RoleProps, id?: string): Role {
    ...
    if (props.code !== undefined && props.code.trim().length === 0) {
      throw new ValidationError("Role code cannot be empty.");
    }
  ...
  public static reconstitute(props: RoleProps, id: string, createdAt: Date, updatedAt: Date): Role {
    return new Role(props, id, createdAt, updatedAt);
  }

  public updateDetails(updates: Partial<RoleProps>): void {
