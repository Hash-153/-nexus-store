 ...
 * Encapsulates state and business invariants for Permission within identity-access.
 */
export class Permission extends Entity<PermissionProps> {
  private _versionNumber: number = 1;

  public constructor(props: PermissionProps, id?: string, createdAt?: Date, updatedAt?: Date) {
  ...
  public static create(props: PermissionProps, id?: string): Permission {
    ...
    if (props.code !== undefined && props.code.trim().length === 0) {
      throw new ValidationError("Permission code cannot be empty.");
    }
  ...
  public static reconstitute(props: PermissionProps, id: string, createdAt: Date, updatedAt: Date): Permission {
    return new Permission(props, id, createdAt, updatedAt);
  }

  public updateDetails(updates: Partial<PermissionProps>): void {
