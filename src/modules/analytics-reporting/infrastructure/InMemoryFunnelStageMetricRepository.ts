...
import type { IFunnelStageMetricRepository, IFunnelStageMetricFilterOptions } from "../domain/IFunnelStageMetricRepository.ts";

/**
 * InMemory Repository for FunnelStageMetric
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryFunnelStageMetricRepository extends InMemoryRepository<FunnelStageMetric> implements IFunnelStageMetricRepository {
  public async findByName(name: string): Promise<FunnelStageMetric | null> {
  ...
  public async findByCode(code: string): Promise<FunnelStageMetric | null> {
  ...
  public async findFiltered(options: IFunnelStageMetricFilterOptions = {}): Promise<FunnelStageMetric[]> {
  ...
  public async count(options: IFunnelStageMetricFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: FunnelStageMetric[]): Promise<void> {
