...
import type { IRefundRateMetricRepository, IRefundRateMetricFilterOptions } from "../domain/IRefundRateMetricRepository.ts";

/**
 * InMemory Repository for RefundRateMetric
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRefundRateMetricRepository extends InMemoryRepository<RefundRateMetric> implements IRefundRateMetricRepository {
  public async findByName(name: string): Promise<RefundRateMetric | null> {
  ...
  public async findByCode(code: string): Promise<RefundRateMetric | null> {
  ...
  public async findFiltered(options: IRefundRateMetricFilterOptions = {}): Promise<RefundRateMetric[]> {
  ...
  public async count(options: IRefundRateMetricFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RefundRateMetric[]): Promise<void> {
