...
import type { IProfitMarginMetricRepository, IProfitMarginMetricFilterOptions } from "../domain/IProfitMarginMetricRepository.ts";

/**
 * InMemory Repository for ProfitMarginMetric
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryProfitMarginMetricRepository extends InMemoryRepository<ProfitMarginMetric> implements IProfitMarginMetricRepository {
  public async findByName(name: string): Promise<ProfitMarginMetric | null> {
  ...
  public async findByCode(code: string): Promise<ProfitMarginMetric | null> {
  ...
  public async findFiltered(options: IProfitMarginMetricFilterOptions = {}): Promise<ProfitMarginMetric[]> {
  ...
  public async count(options: IProfitMarginMetricFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ProfitMarginMetric[]): Promise<void> {
