...
import type { ITrafficSourceMetricRepository, ITrafficSourceMetricFilterOptions } from "../domain/ITrafficSourceMetricRepository.ts";

/**
 * InMemory Repository for TrafficSourceMetric
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryTrafficSourceMetricRepository extends InMemoryRepository<TrafficSourceMetric> implements ITrafficSourceMetricRepository {
  public async findByName(name: string): Promise<TrafficSourceMetric | null> {
  ...
  public async findByCode(code: string): Promise<TrafficSourceMetric | null> {
  ...
  public async findFiltered(options: ITrafficSourceMetricFilterOptions = {}): Promise<TrafficSourceMetric[]> {
  ...
  public async count(options: ITrafficSourceMetricFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: TrafficSourceMetric[]): Promise<void> {
