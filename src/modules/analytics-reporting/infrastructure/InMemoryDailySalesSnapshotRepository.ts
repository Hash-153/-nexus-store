...
import type { IDailySalesSnapshotRepository, IDailySalesSnapshotFilterOptions } from "../domain/IDailySalesSnapshotRepository.ts";

/**
 * InMemory Repository for DailySalesSnapshot
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryDailySalesSnapshotRepository extends InMemoryRepository<DailySalesSnapshot> implements IDailySalesSnapshotRepository {
  public async findByName(name: string): Promise<DailySalesSnapshot | null> {
  ...
  public async findByCode(code: string): Promise<DailySalesSnapshot | null> {
  ...
  public async findFiltered(options: IDailySalesSnapshotFilterOptions = {}): Promise<DailySalesSnapshot[]> {
  ...
  public async count(options: IDailySalesSnapshotFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: DailySalesSnapshot[]): Promise<void> {
