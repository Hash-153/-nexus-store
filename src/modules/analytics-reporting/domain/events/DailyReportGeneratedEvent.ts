...
export interface DailyReportGeneratedEventPayload {
...
/**
 * Domain Event: DailyReportGeneratedEvent
 * Dispatched when  daily report generated event occurs in analytics-reporting.
 */
export class DailyReportGeneratedEvent extends DomainEvent {
  public readonly eventName = "DailyReportGeneratedEvent";
  ...
  constructor(payload: DailyReportGeneratedEventPayload | string) {
    super();
