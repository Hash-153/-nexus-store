...
export interface QuestionAnsweredEventPayload {
...
/**
 * Domain Event: QuestionAnsweredEvent
 * Dispatched when  question answered event occurs in reviews-ratings.
 */
export class QuestionAnsweredEvent extends DomainEvent {
  public readonly eventName = "QuestionAnsweredEvent";
  ...
  constructor(payload: QuestionAnsweredEventPayload | string) {
    super();
