...
export interface ReviewApprovedEventPayload {
...
/**
 * Domain Event: ReviewApprovedEvent
 * Dispatched when  review approved event occurs in reviews-ratings.
 */
export class ReviewApprovedEvent extends DomainEvent {
  public readonly eventName = "ReviewApprovedEvent";
  ...
  constructor(payload: ReviewApprovedEventPayload | string) {
    super();
