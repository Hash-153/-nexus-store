...
import type { ICustomerBadgeRepository, ICustomerBadgeFilterOptions } from "../domain/ICustomerBadgeRepository.ts";

/**
 * InMemory Repository for CustomerBadge
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCustomerBadgeRepository extends InMemoryRepository<CustomerBadge> implements ICustomerBadgeRepository {
  public async findByName(name: string): Promise<CustomerBadge | null> {
  ...
  public async findByCode(code: string): Promise<CustomerBadge | null> {
  ...
  public async findFiltered(options: ICustomerBadgeFilterOptions = {}): Promise<CustomerBadge[]> {
  ...
  public async count(options: ICustomerBadgeFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CustomerBadge[]): Promise<void> {
