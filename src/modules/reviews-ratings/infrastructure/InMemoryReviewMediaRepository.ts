...
import type { IReviewMediaRepository, IReviewMediaFilterOptions } from "../domain/IReviewMediaRepository.ts";

/**
 * InMemory Repository for ReviewMedia
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryReviewMediaRepository extends InMemoryRepository<ReviewMedia> implements IReviewMediaRepository {
  public async findByName(name: string): Promise<ReviewMedia | null> {
  ...
  public async findByCode(code: string): Promise<ReviewMedia | null> {
  ...
  public async findFiltered(options: IReviewMediaFilterOptions = {}): Promise<ReviewMedia[]> {
  ...
  public async count(options: IReviewMediaFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ReviewMedia[]): Promise<void> {
