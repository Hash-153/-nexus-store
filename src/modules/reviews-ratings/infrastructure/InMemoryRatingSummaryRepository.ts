...
import type { IRatingSummaryRepository, IRatingSummaryFilterOptions } from "../domain/IRatingSummaryRepository.ts";

/**
 * InMemory Repository for RatingSummary
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryRatingSummaryRepository extends InMemoryRepository<RatingSummary> implements IRatingSummaryRepository {
  public async findByName(name: string): Promise<RatingSummary | null> {
  ...
  public async findByCode(code: string): Promise<RatingSummary | null> {
  ...
  public async findFiltered(options: IRatingSummaryFilterOptions = {}): Promise<RatingSummary[]> {
  ...
  public async count(options: IRatingSummaryFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: RatingSummary[]): Promise<void> {
