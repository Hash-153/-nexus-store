...
import type { IReviewModerationItemRepository, IReviewModerationItemFilterOptions } from "../domain/IReviewModerationItemRepository.ts";

/**
 * InMemory Repository for ReviewModerationItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryReviewModerationItemRepository extends InMemoryRepository<ReviewModerationItem> implements IReviewModerationItemRepository {
  public async findByName(name: string): Promise<ReviewModerationItem | null> {
  ...
  public async findByCode(code: string): Promise<ReviewModerationItem | null> {
  ...
  public async findFiltered(options: IReviewModerationItemFilterOptions = {}): Promise<ReviewModerationItem[]> {
  ...
  public async count(options: IReviewModerationItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ReviewModerationItem[]): Promise<void> {
