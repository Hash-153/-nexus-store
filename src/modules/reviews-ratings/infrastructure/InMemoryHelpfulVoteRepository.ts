...
import type { IHelpfulVoteRepository, IHelpfulVoteFilterOptions } from "../domain/IHelpfulVoteRepository.ts";

/**
 * InMemory Repository for HelpfulVote
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryHelpfulVoteRepository extends InMemoryRepository<HelpfulVote> implements IHelpfulVoteRepository {
  public async findByName(name: string): Promise<HelpfulVote | null> {
  ...
  public async findByCode(code: string): Promise<HelpfulVote | null> {
  ...
  public async findFiltered(options: IHelpfulVoteFilterOptions = {}): Promise<HelpfulVote[]> {
  ...
  public async count(options: IHelpfulVoteFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: HelpfulVote[]): Promise<void> {
