...
import type { IOrderAddressRepository, IOrderAddressFilterOptions } from "../domain/IOrderAddressRepository.ts";

/**
 * InMemory Repository for OrderAddress
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryOrderAddressRepository extends InMemoryRepository<OrderAddress> implements IOrderAddressRepository {
  public async findByName(name: string): Promise<OrderAddress | null> {
  ...
  public async findByCode(code: string): Promise<OrderAddress | null> {
  ...
  public async findFiltered(options: IOrderAddressFilterOptions = {}): Promise<OrderAddress[]> {
  ...
  public async count(options: IOrderAddressFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: OrderAddress[]): Promise<void> {
