...
import type { IExchangeOrderRepository, IExchangeOrderFilterOptions } from "../domain/IExchangeOrderRepository.ts";

/**
 * InMemory Repository for ExchangeOrder
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryExchangeOrderRepository extends InMemoryRepository<ExchangeOrder> implements IExchangeOrderRepository {
  public async findByName(name: string): Promise<ExchangeOrder | null> {
  ...
  public async findByCode(code: string): Promise<ExchangeOrder | null> {
  ...
  public async findFiltered(options: IExchangeOrderFilterOptions = {}): Promise<ExchangeOrder[]> {
  ...
  public async count(options: IExchangeOrderFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ExchangeOrder[]): Promise<void> {
