...
import type { IOrderCancellationRepository, IOrderCancellationFilterOptions } from "../domain/IOrderCancellationRepository.ts";

/**
 * InMemory Repository for OrderCancellation
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryOrderCancellationRepository extends InMemoryRepository<OrderCancellation> implements IOrderCancellationRepository {
  public async findByName(name: string): Promise<OrderCancellation | null> {
  ...
  public async findByCode(code: string): Promise<OrderCancellation | null> {
  ...
  public async findFiltered(options: IOrderCancellationFilterOptions = {}): Promise<OrderCancellation[]> {
  ...
  public async count(options: IOrderCancellationFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: OrderCancellation[]): Promise<void> {
