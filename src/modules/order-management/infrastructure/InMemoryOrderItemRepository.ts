...
import type { IOrderItemRepository, IOrderItemFilterOptions } from "../domain/IOrderItemRepository.ts";

/**
 * InMemory Repository for OrderItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryOrderItemRepository extends InMemoryRepository<OrderItem> implements IOrderItemRepository {
  public async findByName(name: string): Promise<OrderItem | null> {
  ...
  public async findByCode(code: string): Promise<OrderItem | null> {
  ...
  public async findFiltered(options: IOrderItemFilterOptions = {}): Promise<OrderItem[]> {
  ...
  public async count(options: IOrderItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: OrderItem[]): Promise<void> {
