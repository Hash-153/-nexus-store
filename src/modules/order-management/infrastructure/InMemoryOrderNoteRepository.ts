...
import type { IOrderNoteRepository, IOrderNoteFilterOptions } from "../domain/IOrderNoteRepository.ts";

/**
 * InMemory Repository for OrderNote
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryOrderNoteRepository extends InMemoryRepository<OrderNote> implements IOrderNoteRepository {
  public async findByName(name: string): Promise<OrderNote | null> {
  ...
  public async findByCode(code: string): Promise<OrderNote | null> {
  ...
  public async findFiltered(options: IOrderNoteFilterOptions = {}): Promise<OrderNote[]> {
  ...
  public async count(options: IOrderNoteFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: OrderNote[]): Promise<void> {
