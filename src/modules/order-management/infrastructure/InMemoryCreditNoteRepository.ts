...
import type { ICreditNoteRepository, ICreditNoteFilterOptions } from "../domain/ICreditNoteRepository.ts";

/**
 * InMemory Repository for CreditNote
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryCreditNoteRepository extends InMemoryRepository<CreditNote> implements ICreditNoteRepository {
  public async findByName(name: string): Promise<CreditNote | null> {
  ...
  public async findByCode(code: string): Promise<CreditNote | null> {
  ...
  public async findFiltered(options: ICreditNoteFilterOptions = {}): Promise<CreditNote[]> {
  ...
  public async count(options: ICreditNoteFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: CreditNote[]): Promise<void> {
