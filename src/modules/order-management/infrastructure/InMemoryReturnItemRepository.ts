...
import type { IReturnItemRepository, IReturnItemFilterOptions } from "../domain/IReturnItemRepository.ts";

/**
 * InMemory Repository for ReturnItem
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryReturnItemRepository extends InMemoryRepository<ReturnItem> implements IReturnItemRepository {
  public async findByName(name: string): Promise<ReturnItem | null> {
  ...
  public async findByCode(code: string): Promise<ReturnItem | null> {
  ...
  public async findFiltered(options: IReturnItemFilterOptions = {}): Promise<ReturnItem[]> {
  ...
  public async count(options: IReturnItemFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: ReturnItem[]): Promise<void> {
