...
import type { IOrderTimelineEventRepository, IOrderTimelineEventFilterOptions } from "../domain/IOrderTimelineEventRepository.ts";

/**
 * InMemory Repository for OrderTimelineEvent
 * Thread-safe simulated repository with comprehensive query filtering.
 */
export class InMemoryOrderTimelineEventRepository extends InMemoryRepository<OrderTimelineEvent> implements IOrderTimelineEventRepository {
  public async findByName(name: string): Promise<OrderTimelineEvent | null> {
  ...
  public async findByCode(code: string): Promise<OrderTimelineEvent | null> {
  ...
  public async findFiltered(options: IOrderTimelineEventFilterOptions = {}): Promise<OrderTimelineEvent[]> {
  ...
  public async count(options: IOrderTimelineEventFilterOptions = {}): Promise<number> {
  ...
  public async saveBatch(entities: OrderTimelineEvent[]): Promise<void> {
