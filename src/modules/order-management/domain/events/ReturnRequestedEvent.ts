...
export interface ReturnRequestedEventPayload {
...
/**
 * Domain Event: ReturnRequestedEvent
 * Dispatched when  return requested event occurs in order-management.
 */
export class ReturnRequestedEvent extends DomainEvent {
  public readonly eventName = "ReturnRequestedEvent";
  ...
  constructor(payload: ReturnRequestedEventPayload | string) {
    super();
