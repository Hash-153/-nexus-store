...
/**
 * Domain Event: InvoiceGeneratedEvent
 * Dispatched when  invoice generated event occurs in order-management.
 */
export class InvoiceGeneratedEvent extends DomainEvent {
  public readonly eventName = "InvoiceGeneratedEvent";
  ...
  constructor(payload: InvoiceGeneratedEventPayload | string) {
    super();
